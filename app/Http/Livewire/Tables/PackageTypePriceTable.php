...
class PackageTypePriceTable extends BaseTableComponent
{
    ...
    public function columns()
    {
        return [
            ...
            Column::make(__('Price for Package'),'size_price')->view('components.table.price')->sortable(),
            Column::make(__('Distance Price'),'distance_price')->view('components.table.price')->sortable(),
            Column::make(__('Auto Ready'),'auto_assignment')->view('components.table.bool')->sortable(),
            Column::make(__('Extra fields'), 'field_required')->view('components.table.bool')->sortable(),
